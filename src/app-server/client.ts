import { Duration, Effect, Either, Option, Schema, Scope } from "effect";
...
export type AppServerTaskProvenance =
  | {
      ...
      readonly origin: "cli" | "vscode" | "exec" | "app-server" | "subagent";
    }
  | {
  ...
  private mutate<A, I>(
    ...
    return Effect.uninterruptibleMask((restore) =>
      Effect.gen(this, function* () {
        const prepared = yield* restore(Effect.either(
        ...
        // After submit starts, caller interruption is potentially post-write.
        // The supervising delivery policy must retain ambiguity and reconcile;
        // it must never retry this operation silently.
        const replied = yield* restore(Effect.either(
